...
const Navbar = () => {
    ...
    return (
        <div className='z-50 flex fixed top-0 w-full items-start justify-between pointer-events-none'>
            <Link to='/' className='pointer-events-auto lg:p-6 p-3'>
                <div className='lg:w-[140px] w-[90px] transition-all duration-300 hover:opacity-70'>
            ...
            <button
                ...
                className='pointer-events-auto lg:h-[64px] h-[48px] bg-black relative lg:w-[200px] w-[140px] overflow-hidden cursor-pointer group'
                aria-label='Open menu'
            >
                <div
                    ref={navGreenRef}
                    className='bg-[#D3FD50] absolute bottom-0 h-0 w-full transition-all duration-500 ease-out'
                ></div>
                <div className='relative h-full lg:px-10 px-6 flex flex-col justify-center items-end gap-[6px]'>
                    <div className="lg:w-[48px] w-[36px] h-[2px] bg-white transition-all duration-300"></div>
                    <div className="lg:w-[28px] w-[20px] h-[2px] bg-white transition-all duration-300"></div>
                </div>
            </button>
        </div>
    )
