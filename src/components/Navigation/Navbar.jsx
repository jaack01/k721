    ...
    return (
        <div className='z-50 flex fixed top-0 w-full items-start justify-between'>
            ...
            <button
                ...
                className='lg:h-16 h-12 bg-black relative lg:w-[16vw] w-20 min-w-[80px] cursor-pointer touch-manipulation'
                aria-label='Open navigation menu'
            >
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all duration-300 absolute top-0 h-0 w-full pointer-events-none'></div>
                <div className='relative h-full lg:px-12 px-6 flex flex-col justify-center items-center lg:items-end lg:gap-1.5 gap-1'>
